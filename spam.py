#-*- coding: utf8 -*-
#ya maap kodingan we berantakan :)>
...
class Mate_lampu():
        ...
        def spam_kuy(self):
            ...
            for i in range(1,saapa+1):
                req.headers.update({'user-agent':random.choice(self.ua)});ceko = req.post('https://core.ktbs.io/v2/user/registration/temp', json = {'full_name':'Elang Malaka','user_id':self.goblok,'user_id_type':self.tolol})
